...
- (void)commonInit {
    ...
    self.arrowSize = CGSizeMake(11.0, 0.0);
    self.cornerRadius = 4.0;
    self.backgroundColor = [UIColor whiteColor];
    self.animationIn = 0.5;
    self.animationOut = 0.5;
    self.animationSpring = YES;
    self.sideEdge = 0.0;
    self.maskType = DXPopoverMaskTypeBlack;
    self.betweenAtViewAndArrowHeight = 0.0;
...
- (void)showAtPoint:(CGPoint)point
    ...
    switch (self.maskType) {
        case DXPopoverMaskTypeBlack:
            maskColor = [UIColor colorWithWhite:0.0 alpha:0.7];
            break;
